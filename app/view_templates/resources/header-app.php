...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= view_templates ?>emmares/app-assets/vendors/css/charts/apexcharts.css">
    <link rel="stylesheet" type="text/css" href="<?= view_templates ?>emmares/app-assets/vendors/css/extensions/toastr.min.css">
    <link rel="stylesheet" type="text/css" href="<?= view_templates ?>emmares/app-assets/vendors/css/tables/datatable/datatables.min.css">
    <link rel="stylesheet" type="text/css" href="<?= view_templates ?>emmares/app-assets/vendors/css/tables/datatable/responsive.bootstrap.min.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?= view_templates ?>emmares/app-assets/css/plugins/charts/chart-apex.css">
    <link rel="stylesheet" type="text/css" href="<?= view_templates ?>emmares/app-assets/css/plugins/extensions/ext-component-toastr.css">
    <link rel="stylesheet" type="text/css" href="<?= view_templates ?>emmares/app-assets/css/pages/app-invoice-list.css">
    <!-- END: Page CSS-->
